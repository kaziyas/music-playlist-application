package com.media.app.security;

import com.media.app.config.AppProperties;
import com.media.app.service.security.SecurityService;
import com.media.app.service.security.TokenDTO;
  ...
  private String fetchToken() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            appProperties.getTokenApiUrl(), HttpMethod.POST, request, String.class);
